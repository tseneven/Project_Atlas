...
class LoginService {
  ...
  Future<FunctionResult> login(LoginModel model) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return FunctionResult(false, Error: "Упс, что-то пошло не так " + response.statusCode.toString());
    } catch (ex) {
      return FunctionResult(false, Error: "Упс, что-то пошло не так " + ex.toString());
    }
  }
}
